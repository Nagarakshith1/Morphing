...
def cpselect(img1,img2):
	...
	point.left_x = point.left_x+[0,0,300,300]
	point.left_y = point.left_y + [0, 300, 0, 300]
	point.right_x = point.right_x+[0,0,300,300]
	point.right_y = point.right_y + [0, 300, 0, 300]
